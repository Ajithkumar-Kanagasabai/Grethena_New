            ...
            <section>
                ...
                <div className="p-4 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-[60px] pr-[60px] 1">
                            ...
                            <Image src={Office_Entrance} alt="Logo" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Second Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Office_Lounge} alt="Office Lounge" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Third Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Conference_Room} alt="Conference Room" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-[60px] pr-[60px] pt-[40px]">
                            {/* First Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Office_Room4} alt="Logo" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Second Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Office_Room5} alt="Office Lounge" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Third Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Office_Room6} alt="Conference Room" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-[60px] pr-[60px] pt-[40px]">
                            {/* First Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={Office_Room7} alt="Logo" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                        </div>
                     </div>
                     ...
                     <div className="p-4 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-[60px] pr-[60px]">
                            {/* First Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={birthday_1} alt="Logo" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Second Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={birthday_2} alt="Office Lounge" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Third Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={birthday_3} alt="Conference Room" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                        </div>
                    </div>

                    <div className="p-4 text-center">
                        <h1 className="text-2xl font-bold mb-4 p-[39px]">TEAM GET TOGETHER</h1>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-[60px] pr-[60px]">
                            {/* First Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={team_get_1} alt="Logo" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Second Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={team_get_2} alt="Office Lounge" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                            {/* Third Image */}
                            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                            <Image src={team_get_3} alt="Conference Room" className="w-full border-2 border-[#cfcfcf]" />
                            </div>
                        </div>
                    </div>
