      ...
      <section>
        ...
        <div className="m-0 mx-12 text-[24px] text-[#7A7A7A]">
          <div className="">
            ...
            <p className="text-sm  text-[24px] text-[#7A7A7A] font-medium mt-[32px] mb-8">
              ...
              <table className="min-w-full border">
                <tbody>
                  <tr className="border-b">
                    <td className="px-4 py-2 font-semibold border border-gray-300 p-[0.5em]">
                      Data
                    </td>
                    <td className="px-4 py-2 border border-gray-300 p-[0.5em]">
                      collectively all information that you submit to Grethena
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300 p-[0.5em]">
                      Grethena of Forest house, 16-20 Clements road, London, IG1
                      1BA;
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300 p-[0.5em]">
                      ...
                      either (i) employed by Grethena and acting in the course
                      of their employment or (ii) engaged as a consultant or
                      otherwise providing services to Grethena and accessing the
                  ...
                  <tr className="border-b">
                    ...
                    <td className="px-4 py-2 border border-gray-300 p-[0.5em]">
                      ...
                      https://grethena.com/, and any sub-domains of this site
          ...
          <div className="text-base leading-relaxed space-y-2 text-[24px] text-[#7A7A7A]">
            <p className="font-medium mt-[42px] mb-5">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <span className="font-semibold">“Including”</span> is understood
          ...
          <div className="text-base leading-relaxed space-y-4 text-[24px] text-[#7A7A7A]">
            ...
            <p>
              ...
              <span className="font-semibold">Grethena</span> and Users with
              respect to this Website. It does not extend to any websites that
              can be accessed from this Website including, but not limited to,
              any links we may provide to social media websites.
            </p>
            <p>
              4. For purposes of the applicable Data Protection Laws,{" "}
              <span className="font-semibold">Grethena</span> is the “data
              controller”. This means that Grethena determines the purposes for
            ...
            <p>
              7. Grethena will collect your Data in a number of ways, for
              example:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
            ...
            <p>
              11. We may share your Data with the following groups of people for
              the following reasons:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Our employees, agents and/or professional advisors – to
                understand the requirement of the customer; in each case, in
            ...
            <p>
              12. We will use technical and organisational measures to safeguard
            ...
            <p>
              13. We are certified to SOC 2. This family of standards helps us
            ...
            <p>
              ...
              support@grethena.com.
            </p>
            <p>
              15. If you want detailed information from Get Safe Online on how
              to protect your information and your computers and devices against
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <span className="font-medium">Right to access – </span>the right
                to request (i) copies of the information we hold about you at
              ...
              <li>
                <span className="font-medium">Right to correct – </span>the
                right to have your Data rectified if it is inaccurate or
                incomplete.
              </li>
              <li>
                <span className="font-medium">Right to erase – </span>the right
            ...
            <p>
              23. Grethena may, from time to time, expand or reduce our business
              and this may involve the sale and/or the transfer of control of
              all or part of Grethena. Data provided by Users will, where it is
            ...
            <p>
              28. Unless otherwise agreed, no delay, act or omission by a party
            ...
            <p>
              30. Grethena reserves the right to change this privacy policy as
