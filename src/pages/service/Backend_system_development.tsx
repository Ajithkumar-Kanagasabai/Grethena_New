...
const Backend_system_development = () => {
  return (
    <div>
      <Header />
      <div className="text-gray-700 font-Quicksand p-8 min-h[700px]">
        <div className="text-center">
          <h2 className="text-4xl text-center text-black mt-[4rem] mb-[2.5rem] font-bold">
            {" "}
        ...
        <div className="text-[1.5rem]">
          ...
          <p className="mt-5 mb-5">
            ...
            systems that support complex workflows and ensure seamless data
            flow. We design architecture that grows with your business,
            optimizing for security, scalability, and reliability.
          </p>
          ...
          <div className="flex items-center gap-4  mt-[3rem]">
            ...
            <p>
              Database Management: Secure and efficient storage solutions
          ...
          <div className="flex items-center gap-4 mt-[3rem] ">
            ...
            <p>
              Scalability & Reliability: Architecture that adapts as your
              business expands.
            </p>
          </div>
          <div className="flex items-center gap-4 mt-[3rem] ">
