        ...
        <div className="w-full">
            <section className="text-white py-8 lg:py-16 px-4 md:px-20" style={{ backgroundImage: 'url(/assets/about/ourvision.png)', backgroundSize: 'cover', backgroundPosition: 'center', height: '100%', width: '100%' }}>
                ...
                <p className="text-lg md:text-xl mb-6">
                    Join us at Grethena and take the first step towards a rewarding and impactful career in technology. Together, we can achieve greatness.
                </p>
                <p className="text-xl md:text-2xl font-semibold text-center">
                    “Grethena – Empowering Latin American Talent for a Brighter Future in IT”
                </p>
            </section>
            ...
            <section className="bg-gray-100 text-gray-800 py-8 lg:py-16 px-4 md:px-20">
                ...
                <p className="text-lg md:text-xl mt-8">
                    At Grethena, we aim to empower Latin American talent by providing rigorous training programs that equip individuals with the skills needed to thrive in the global IT sector. We strive to bridge the gap between ambition and achievement, ensuring our students are prepared for success in remote job opportunities with UK clients and beyond.
                </p>
            </section>
        </div>
    );
