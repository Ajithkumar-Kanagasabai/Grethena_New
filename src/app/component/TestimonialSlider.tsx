...
const testimonials = [
    {
        ...
        role: 'Student',
        image: JhonDoe,
        text: 'I recently completed an IT training course through the Grethena Portal. The content was excellent, and the instructors were knowledgeable. The online platform was easy to use, and the support team was very helpful. Thanks to this training, I improved my skills and got a new job in IT. I highly recommend LATAM Training Portal.',
        rating: 5,
    },
    {
        name: 'Steve Rogers',
